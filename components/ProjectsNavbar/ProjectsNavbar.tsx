...
const NavItem: FunctionComponent<{
  ...
  return (
    <li
      className="capitalize transition ease-in-out cursor-pointer duration-250 hover:text-green nav-item"
      onClick={e => {
        clearNavItems();
        (e.target as HTMLElement).closest(".nav-item").classList.add("active");
