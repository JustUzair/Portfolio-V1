...
import { FaServer, FaCss3Alt, FaPython, FaJava, FaNodeJs } from "react-icons/fa"
...
export const projects: IProject[] = [
    ...
    },
    {
        id: 2,
        name: "Beach Resorts",
        description: "Showcasing available rooms in the resort and providing info for the same. Technologies used:- ReactJS and Contentful (CMS/BYOF)",
        image_path: ["/images/BeachResorts/1.JPG", "/images/BeachResorts/2.JPG", "/images/BeachResorts/3.JPG"],
        deployed_url: "https://react-beach-resorts-uzair.netlify.app/",
        github_url: "https://github.com/JustUzair/react-beach-resorts",
        category: ["react"],
        key_techs: ["React", "Contentful API", "Netlify", "Github CI/CD", "Netlify Hosting"]

    },
    {
        id: 3,
        name: "Tech Store",
        description: "ReactJS based project called tech store, which is an online tech hardware store built using ReactJS, Bootstrap, Contentful (Headless CMS), and also includes PayPal sandbox payment. The website is pure ReactJS and is front-end only and it uses the static data from Contentful API. Test Credentials for paypal sandbox are:    Email:-abc@techstore.com Password:-abcdabcd",
        image_path: ["/images/TechStore/1.JPG", "/images/TechStore/2.JPG", "/images/TechStore/3.JPG"],
        deployed_url: "https://react-tech-store-uzair.netlify.app/",
        github_url: "https://github.com/JustUzair/react-tech-store",
        category: ["react"],
        key_techs: ["React", "Contentful API", "Paypal SandBox API", "BootStrap", "Github CI/CD", "Netlify Hosting"]
    ...
    },
    {
        ...
        image_path: ["/images/LinkedInClone/1.JPG", "/images/LinkedInClone/2.JPG", "/images/LinkedInClone/3.JPG", "/images/LinkedInClone/4.JPG", "/images/LinkedInClone/5.JPG", "/images/LinkedInClone/6.JPG"],
